...
public class ApplicationSecurity extends WebSecurityConfigurerAdapter implements WebMvcConfigurer{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.cors().disable().csrf().disable().authorizeRequests()
            ...
            .antMatchers("/fdm/inviteTokenList.xhtml").hasRole("ADMIN")
            .antMatchers("/fdm/accessTokenList.xhtml").hasRole("ADMIN")
            .antMatchers("/fdm/accessGroupSearchResults.xhtml").hasRole("ADMIN")
