...
public interface RestResultController {
	...
	/**
	 * Update a script result response.
	 * 
	 * @param httpHeaders
	 *            http Headers.
	 * 
	 ...
	 * 
	 * @param resOrderNo
	 *            The res order no of the response to edit.
	 *            
	 * @param updateScriptResult
	 *            UpdateScriptResult message.
	 *            
	 * @return CallResponse message.
	 * 
	 * @
	 ...
	 *             If returnid is not a valid number.
	 */
	ResponseEntity<CallResponse> updateScriptResultResponse(HttpHeaders httpHeaders, int returnid,
															int resOrderNo, UpdateScriptResult updateScriptResult)
			throws BadRequestException;	
