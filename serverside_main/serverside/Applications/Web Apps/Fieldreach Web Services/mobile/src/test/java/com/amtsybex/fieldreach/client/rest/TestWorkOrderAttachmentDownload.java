...
public class TestWorkOrderAttachmentDownload extends CommonBase 
{

	static Logger log = LoggerFactory.getLogger(TestWorkOrderAttachmentDownload.class.getName());
	...
	public void test_1() 
	{
		...
		headersVariables.put("workorderno", woAttachmentInvalidWoNo);
		headersVariables.put("filename", "XXX");
		
		initiate(requestHeaders, headersVariables, woAttachmentInvalidWoNo, HttpStatus.UNAUTHORIZED);
	}
	...
	@Test
	@TestDescription(desc="Initiate download of work order attachment. Specify a workorder " +
			"that does not exist in the workissue table. Check that WorkOrderNotFoundException is " +
			"returned.")
	...
	public void test_10() 
	{
		...
		response = initiate(requestHeaders, headersVariables, woAttachmentInvalidDistrict,
				HttpStatus.OK);
		...
		assertTrue("Unexpected Exception returned." +
				"<br/><br/><b>Expected:</b> " + Utils.WORKORDER_NOT_FOUND_EXCEPTION + 
				"<br><b>Found:</b> " + response.getError().getErrorCode(), 
				response.getError().getErrorCode().equals(Utils.WORKORDER_NOT_FOUND_EXCEPTION));
	}
	
	
	@Test
	@TestDescription(desc="Initiate download of work order attachment. Specify a workorder " +
			"that exists in the workissue table, but specify a file that does not exist in the" +
			"attachment folder. Check that FileNotFoundException is returned.")
	...
	public void test_11() 
	{
		...
		Map<String, String> headersVariables = new HashMap<String, String>();
		headersVariables.put("workorderno", woAttachmentValidWoNo);
		headersVariables.put("filename", woAttachmentInvalidFileName);
		
		InitiateDownloadResponse response = null;
		response = initiate(requestHeaders, headersVariables, woAttachmentValidDistrict,
				HttpStatus.OK);
	...
	@Test
	@TestDescription(desc="Initiate download of work order attachment. Specify a workorder " +
			"that exists in the workissue table, and specify a file that does  exist in the" +
			"attachment folder but is too large for download. Check that MaximumFileSizeExceededException " +
			" is returned.")
	...
	public void test_12() 
	{
		...
		Map<String, String> headersVariables = new HashMap<String, String>();
		headersVariables.put("workorderno", woAttachmentValidWoNo);
		headersVariables.put("filename", woAttachmentMaxSizeFileName);
	...
	@Test
	@TestDescription(desc="Initiate download of work order attachment. Specify a workorder " +
			"that exists in the workissue table, and specify a file that can be downloaded. " +
			"Verify response message success element is true, an identifier has been generated, " +
			"total parts and checksum are all returned.")
	...
	public void test_13() 
	{
		...
		Map<String, String> headersVariables = new HashMap<String, String>();
		headersVariables.put("workorderno", woAttachmentValidWoNo);
		headersVariables.put("filename", woAttachmentValidFileName);
	...
	@TestDescription(desc="Attempt to download part. Specify a valid identifier with part " +
			...
			"returned.")
	@TestLabel(label="Reference: 2825")
	public void test_25() 
	{
		String dateHeader = getDateHeader();
	...
	@TestLabel(label="Reference: 2826")
	public void test_26() 
	{
		String dateHeader = getDateHeader();
	...
	@TestLabel(label="Reference: 2827")
	public void test_27() 
	{
		String dateHeader = getDateHeader();
		...
		Common.writeBytesToFile(assembledParts, m_fileName, retrieveWorkOrderAttachmentDir);
	}
	...
	public InitiateDownloadResponse initiate(HttpHeaders requestHeaders, 
			Map<String, String> headersVariables, String district, HttpStatus expectedStatusCode)
	{
		final String wsURL = baseURL + "/workorder/{workorderno}/attachment/{filename:.*}";
	...
	{
		final String wsURL = baseURL + "/workorder/{workorderno}/attachment/{filename:.*}/multipart/{identifier}/{part}";
