...
public class TestAssetDatabase extends CommonBase {

	static Logger log = LoggerFactory.getLogger(TestAssetDatabase.class.getName());

	private boolean test1514 = false;
	...
	@Test
	@TestDescription(desc = "Attempt get asset manager database file details without Date header and "
	...
	@Test
	@TestDescription(desc = "Attempt get asset manager database file details with invalid Date header "
	...
	@Test
	@TestDescription(desc = "Attempt get asset manager database file details with date header not "
	...
	@Test
	@TestDescription(desc = "Get Server time. Attempt get asset manager database file details "
	...
	@Test
	@TestDescription(desc = "Attempt get asset manager database file details with valid "
	...
	@Test
	@TestDescription(desc = "Attempt get asset manager database file details with "
			+ "valid Authorization details and passing dbClass parameter equal "
			+ "to DU01.<br>"
			+ "Check HTTP status code is 200 OK.<br><br>"
			+ "Check message corresponds to AssetDatabaseResponse message with "
	...
	public void test_10() {
		...
		assertTrue("File name not as expected. <br> <b>Expected:</b> "
				+ DU01FileName + "<br><b>Recieved: </b>"
				+ resp.getFull().getName(),
				resp.getFull().getName().equals(DU01FileName));

		assertTrue("Checksum not as expected. <br> <b>Expected:</b> "
				+ DU01Checksum + "<br><b>Recieved: </b>"
				+ resp.getFull().getChecksum(), resp.getFull().getChecksum()
				.equals(DU01Checksum));

		assertTrue("Size not as expected. <br> <b>Expected:</b> " + DU01Size
				+ "<br><b>Recieved: </b>" + resp.getFull().getSizeBytes(), resp
				.getFull().getSizeBytes() == DU01Size);
	}
	...
	@TestDescription(desc = "Attempt get asset manager database file details with valid "
			...
			+ "class literal (dbClass=NOTEXIST).<br>"
			+ "Check HTTP status code is 200 OK.<br><br>"
			+ "Check message corresponds to AssetDatabaseResponse message Check success "
			+ "element is false. Check error code is set to "
			+ Utils.ASSET_DB_NOT_FOUND)
	...
	public void test_13() {
		...
		assertTrue("Unexcepted exception returned. expected "
				+ Utils.ASSET_DB_NOT_FOUND + " recieved "
				+ resp.getError().getErrorCode(), resp.getError()
				.getErrorCode().equals(Utils.ASSET_DB_NOT_FOUND));
	}

	@Test
	@TestDescription(desc = "Attempt get asset manager database file details with valid Authorization"
			+ "details and passing dbClass parameter equal to DU01. "
			+ "Check HTTP status code is 200 OK.<br><br>"
			+ "Check message corresponds to AssetDatabaseResponse message with non-empty database name, "
	...
	public void test_24() {
		...
		Map<String, String> headersVariables = new HashMap<String, String>();
		headersVariables.put("filename", assetDatabaseInvalid);
	...
	public void test_25() {
		...
		Map<String, String> headersVariables = new HashMap<String, String>();
		headersVariables.put("filename", assetDatabaseFileMaxSizeFileName);
	...
	@TestDescription(desc = "Attempt to download part with valid date header and valid authorization "
			+ "token.<br>Invalid user specified in the authorization header.")
	@TestLabel(label = "Reference: 1534")
	public void test_34() {
	...
	@TestLabel(label = "Reference: 1539")
	public void test_39() {
	...
	@TestLabel(label = "Reference: 1540")
	public void test_40() {
		...
		Common.writeBytesToFile(assembledParts, m_fileName,
				assetDatabaseDownloadDir);
	}

	// Get details of the latest available asset database.
	public AssetDatabaseResponse getDBDetails(
			Map<String, String> headersVariables, HttpHeaders requestHeaders,
			HttpStatus expectedStatusCode, String dbClass) {

		log.debug(">>> getDBDetails ");

		final String wsURL = baseURL + "database/assetManager";

		RestOperations restTemplate = null;
		restTemplate = new RestTemplate();

		StringBuffer restCall;
		AssetDatabaseResponse requestResponse = null;
		...
		try {
			...
			try {
				...
				xstream.alias("AssetDatabaseResponse",
						AssetDatabaseResponse.class);
				requestResponse = (AssetDatabaseResponse) xstream
						.fromXML(results);
	...
	public InitiateDownloadResponse initiate(HttpHeaders requestHeaders,
			Map<String, String> headersVariables, HttpStatus expectedStatusCode, String dbClass) {

		final String wsURL = baseURL
				+ "database/assetManager/{filename:.*}/multipart";
	...
	public DownloadPartResponse retrievePart(HttpHeaders requestHeaders,
		...
		final String wsURL = baseURL
				+ "database/assetManager/{filename:.*}/multipart/{identifier}/{part}";
