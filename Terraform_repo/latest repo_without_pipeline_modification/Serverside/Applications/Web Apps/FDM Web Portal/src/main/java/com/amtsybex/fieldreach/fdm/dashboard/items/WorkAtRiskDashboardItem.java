...
public class WorkAtRiskDashboardItem extends DashboardItem implements Serializable{

	private static final long serialVersionUID = -5043871205801961226L;
	
	transient String xAxisOption;

	public WorkAtRiskDashboardItem(String username, int order, DashboardServiceManager serviceManager) {
